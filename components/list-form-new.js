...
export default class ListFormNew extends Component {
  // constructor(props) {
  //   super(props);
  // }
  ...
  onSubmit = async() => {
    ...
    FormData.values.userId = this.props.session.user.id;
    ...
    if (response._id) {
      ...
      // TODO: use Next routing instead of vanilla js
      window.location.href = `/lists/${response._id}`;
    }
  }
